...
SECRET_KEY = 'django-insecure-_&a!s7-_iwry&edj+ezrk*vgqynfup&n^xv5)i-=(t2#%c+j=y'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['django-library-online.herokuapp.com']
...
#         'NAME': 'library', # default is BASE_DIR / 'db.sqlite3'
